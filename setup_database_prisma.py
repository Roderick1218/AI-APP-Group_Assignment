...
# Get Prisma database connection
DATABASE_ONLINE_URL = os.getenv("DATABASE_ONLINE")

if not DATABASE_ONLINE_URL:
    print("Error: DATABASE_ONLINE not found in .env file")
    exit(1)
...
try:
    ...
    print(f"Connected to Prisma database successfully!")
    ...
    # Commit changes
    conn.commit()
    print(f"Prisma database setup completed successfully!")

except psycopg2.OperationalError as e:
    print(f"Could not connect to Prisma database: {e}")
    print("Please check:")
    print("1. DATABASE_ONLINE connection string is correct")
